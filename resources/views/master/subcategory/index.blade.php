...
@section('content')
   ...
   <div class="row">
      <div class="col-sm-12 col-md-6">         
         <h2 class="text-dark"> Subcategories </h2>
      </div>
      <div class="col-sm-12 col-md-6">         
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
               ...
               @endif
               <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('subcategory.index') }}">Subcategories</a></li>
            </ol>
         </nav>
      </div>
   </div>
   <div class="card">
      <div class="row">
         <div class="col-sm-12 col-md-12 pb-20 text-right"> 
            <a href="{{ route('subcategory.create') }}" class="btn btn-success" > <i class="fa fa-plus"></i> &nbsp; Add Subcategory </a>              
         </div>  
         <div class="col-sm-12 col-md-12"> 
            @include('master.subcategory.table')
         </div>    
      </div>
   </div>
@stop
